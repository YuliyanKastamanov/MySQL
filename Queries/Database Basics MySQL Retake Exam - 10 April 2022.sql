...
concat((reverse(a.last_name)), (char_length(a.last_name)), '@cast.com') AS email, (2022 - year(a.birthdate)) AS age, a.height
FROM actors AS a
...
(CASE 
    ...
    ma.budget
FROM movies AS m
LEFT JOIN movies_additional_info AS ma
ON m.movie_info_id = ma.id
